...
resume_data = {
    ...
    "summary": "Experienced Data Analyst with a passion for transforming data into actionable insights.",
    "skills": [
        "Python",
        "SQL",
        "Excel",
    ...
    "experience": [
        "Data Analyst at TechCorp (2021–Present): Analyzed customer behavior data to improve product strategy, reducing churn by 12%.",
        "Junior Analyst at DataWiz (2019–2021): Built dashboards in Tableau to track KPIs and created automated Excel reports.",
    ],
    "education": [
        "B.Sc. in Computer Science, University of California, Berkeley (2015–2019)"
    ],
    "certifications": [
    ...
    "projects": [
        "Built a sales forecasting model using Python and scikit-learn",
        "Developed a real-time dashboard to monitor web traffic using Power BI"
    ],
...
# Example search
jobs = agent.search_jobs(resume_data, "data analyst", "New York", count=5)

# Analyze match between resume and a specific job
analysis = agent.get_job_match_analysis(resume_data, jobs[0])
